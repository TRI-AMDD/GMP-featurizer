...
extern "C" int calculate_solid_gmpordernorm_elemental_sigma_cutoff(double** cell, double** cart, double* occupancies, double** ref_cart, double** scale, double** ref_scale, int* pbc_bools,
...
extern "C" int calculate_solid_gmpordernorm_elemental_sigma_gaussian_cutoff(double** cell, double** cart, double* occupancies, double** ref_cart, double** scale, double** ref_scale, int* pbc_bools,
...
extern "C" int calculate_solid_gmpordernorm_elemental_sigma_cutoff_occ_derivative(double** cell, double** cart, double* occupancies, double** ref_cart, double** scale, double** ref_scale, int* pbc_bools,
                                        int* atom_i, int natoms, /*int* cal_atoms,*/ int cal_num, int nsigmas,
                                        int** params_i, double** params_d, int nmcsh, double** atom_gaussian, int* ngaussians, double** elemental_sigma_cutoffs, int* element_index_to_order,
...
extern "C" int calculate_solid_gmpordernorm_noderiv_elemental_sigma_gaussian_cutoff(double** cell, double** cart, double* occupancies, double** ref_cart, double** scale, double** ref_scale, int* pbc_bools,
                                        int* atom_i, int natoms, /*int* cal_atoms,*/ int cal_num, int nsigmas, int max_n_gaussian,
                                        int** params_i, double** params_d, int nmcsh, double** atom_gaussian, int* ngaussians, double** elemental_sigma_cutoffs, double** elemental_sigma_gaussian_cutoffs, int* element_index_to_order,
                                        double** mcsh) {
