...
{
    SolidGMPFunctionNoderivOpt2_2 result;
    if (mcsh_order == -1) {
        result = calc_solid_MCSH_n1_noderiv_opt2_2;
    } else if (mcsh_order == 0) {
        result = calc_solid_MCSH_0_noderiv_opt2_2;
    } else if (mcsh_order == 1) {
        result = calc_solid_MCSH_1_noderiv_opt2_2;
    } else if (mcsh_order == 2) {
        result = calc_solid_MCSH_2_noderiv_opt2_2;
    } else if (mcsh_order == 3) {
        result = calc_solid_MCSH_3_noderiv_opt2_2;
    } else if (mcsh_order == 4) {
        result = calc_solid_MCSH_4_noderiv_opt2_2;
    } else if (mcsh_order == 5) {
        result = calc_solid_MCSH_5_noderiv_opt2_2;
    } else if (mcsh_order == 6) {
        result = calc_solid_MCSH_6_noderiv_opt2_2;
    } else if (mcsh_order == 7) {
        result = calc_solid_MCSH_7_noderiv_opt2_2;
    } else if (mcsh_order == 8) {
        result = calc_solid_MCSH_8_noderiv_opt2_2;
    } else if (mcsh_order == 9) {
        result = calc_solid_MCSH_9_noderiv_opt2_2;
    }
    return result;
}
...
double get_docc_value_opt2(int mcsh_order, double* v, double *u){
    ...
    if (mcsh_order == -1) {
        ...
        return (v[0] * u[0] + v[1] * u[1] + v[2] * u[2]) 
                + (2.0 * (v[3] * u[3] + v[4] * u[4] + v[5] * u[5]));
        
    } else if (mcsh_order == 3) {
        return (v[0] * u[0] + v[1] * u[1] + v[2] * u[2]) 
                + (3.0 * (v[3] * u[3] + v[4] * u[4] + v[5] * u[5] + v[6] * u[6] + v[7] * u[7] + v[8] * u[8]))
                + (6.0 * u[9] * u[9]);
        
    } else if (mcsh_order == 4) {
        return (v[0] * u[0] + v[1] * u[1] + v[2] * u[2]) 
                + (4.0 * (v[3] * u[3] + v[4] * u[4] + v[5] * u[5] + v[6] * u[6] + v[7] * u[7] + v[8] * u[8]))
                + (6.0 * (v[9] * u[9] + v[10] * u[10] + v[11] * u[11]))
                + (12.0 * (v[12] * u[12] + v[13] * u[13] + v[14] * u[14]));
        
    } else if (mcsh_order == 5) {
        return (v[0] * u[0] + v[1] * u[1] + v[2] * u[2]) 
                + (5.0 * (v[3] * u[3] + v[4] * u[4] + v[5] * u[5] + v[6] * u[6] + v[7] * u[7] + v[8] * u[8]))
                + (10.0 * (v[9] * u[9] + v[10] * u[10] + v[11] * u[11] + v[12] * u[12] + v[13] * u[13] + v[14] * u[14]))
                + (20.0 * (v[15] * u[15] + v[16] * u[16] + v[17] * u[17]))
                + (30.0 * (v[18] * u[18] + v[19] * u[19] + v[20] * u[20]));
        
    } else if (mcsh_order == 6) {
        return (v[0] * u[0] + v[1] * u[1] + v[2] * u[2]) 
                + (6.0 * (v[3] * u[3] + v[4] * u[4] + v[5] * u[5] + v[6] * u[6] + v[7] * u[7] + v[8] * u[8]))
                + (15.0 * (v[9] * u[9] + v[10] * u[10] + v[11] * u[11] + v[12] * u[12] + v[13] * u[13] + v[14] * u[14]))
                + (30.0 * (v[15] * u[15] + v[16] * u[16] + v[17] * u[17]))
                + (20.0 * (v[18] * u[18] + v[19] * u[19] + v[20] * u[20]))
                + (60.0 * (v[21] * u[21] + v[22] * u[22] + v[23] * u[23] + v[24] * u[24] + v[25] * u[25] + v[26] * u[26]))
                + (90.0 * v[27] * u[27]);
        
    } else if (mcsh_order == 7) {
        return (v[0] * u[0] + v[1] * u[1] + v[2] * u[2]) 
                + (7.0 * (v[3] * u[3] + v[4] * u[4] + v[5] * u[5] + v[6] * u[6] + v[7] * u[7] + v[8] * u[8]))
                + (21.0 * (v[9] * u[9] + v[10] * u[10] + v[11] * u[11] + v[12] * u[12] + v[13] * u[13] + v[14] * u[14]))
                + (42.0 * (v[15] * u[15] + v[16] * u[16] + v[17] * u[17]))
                + (35.0 * (v[18] * u[18] + v[19] * u[19] + v[20] * u[20] + v[21] * u[21] + v[22] * u[22] + v[23] * u[23]))
                + (105.0 * (v[24] * u[24] + v[25] * u[25] + v[26] * u[26] + v[27] * u[27] + v[28] * u[28] + v[29] * u[29]))
                + (140.0 * (v[30] * u[30] + v[31] * u[31] + v[32] * u[32]))
                + (210.0 * (v[33] * u[33] + v[34] * u[34] + v[35] * u[35]));
        
    } else if (mcsh_order == 8) {
        return (v[0] * u[0] + v[1] * u[1] + v[2] * u[2]) 
                + (8.0 * (v[3] * u[3] + v[4] * u[4] + v[5] * u[5] + v[6] * u[6] + v[7] * u[7] + v[8] * u[8]))
                + (28.0 * (v[9] * u[9] + v[10] * u[10] + v[11] * u[11] + v[12] * u[12] + v[13] * u[13] + v[14] * u[14]))
                + (56.0 * (v[15] * u[15] + v[16] * u[16] + v[17] * u[17]))
                + (56.0 * (v[18] * u[18] + v[19] * u[19] + v[20] * u[20] + v[21] * u[21] + v[22] * u[22] + v[23] * u[23]))
                + (168.0 * (v[24] * u[24] + v[25] * u[25] + v[26] * u[26] + v[27] * u[27] + v[28] * u[28] + v[29] * u[29]))
                + (70.0 * (v[30] * u[30] + v[31] * u[31] + v[32] * u[32]))
                + (280.0 * (v[33] * u[33] + v[34] * u[34] + v[35] * u[35] + v[36] * u[36] + v[37] * u[37] + v[38] * u[38]))
                + (420.0 * (v[39] * u[39] + v[40] * u[40] + v[41] * u[41]))
                + (560.0 * (v[42] * u[42] + v[43] * u[43] + v[44] * u[44]));
    } else if (mcsh_order == 9) {
        return (v[0] * u[0] + v[1] * u[1] + v[2] * u[2]) 
                + (9.0 * (v[3] * u[3] + v[4] * u[4] + v[5] * u[5] + v[6] * u[6] + v[7] * u[7] + v[8] * u[8]))
                + (36.0 * (v[9] * u[9] + v[10] * u[10] + v[11] * u[11] + v[12] * u[12] + v[13] * u[13] + v[14] * u[14]))
                + (72.0 * (v[15] * u[15] + v[16] * u[16] + v[17] * u[17]))
                + (84.0 * (v[18] * u[18] + v[19] * u[19] + v[20] * u[20] + v[21] * u[21] + v[22] * u[22] + v[23] * u[23]))
                + (252.0 * (v[24] * u[24] + v[25] * u[25] + v[26] * u[26] + v[27] * u[27] + v[28] * u[28] + v[29] * u[29]))
                + (126.0 * (v[30] * u[30] + v[31] * u[31] + v[32] * u[32] + v[33] * u[33] + v[34] * u[34] + v[35] * u[35]))
                + (504.0 * (v[36] * u[36] + v[37] * u[37] + v[38] * u[38] + v[39] * u[39] + v[40] * u[40] + v[41] * u[41]))
                + (756.0 * (v[42] * u[42] + v[43] * u[43] + v[44] * u[44]))
                + (630.0 * (v[45] * u[45] + v[46] * u[46] + v[47] * u[47]))
                + (1260.0 * (v[48] * u[48] + v[49] * u[49] + v[50] * u[50] + v[51] * u[51] + v[52] * u[52] + v[53] * u[53]))
                + (1680.0 * v[54] * u[54]);
    }
